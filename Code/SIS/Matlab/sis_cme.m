%%
function []=sis_cme(N,m1,m2,s1,s2,beta)
%%
tic
...
J = beta/N  * ( Tm10*T01  - I)* TWx2 * TWx1 +...    %(S,I)->(S-1,I+1)
    gamma *   ( T10*T0m1  - I)* TWx2;               %(S,I)->(S+1,I-1)
...
folder_name = sprintf('data_sis_v0/%d_%d_%d_%d_%d/CME/',N,m1,m2,s1,s2)
mkdir(folder_name)
filename = sprintf('data_sis_v0/%d_%d_%d_%d_%d/CME/%.3e.csv',N,m1,m2,s1,s2,beta/gamma)
